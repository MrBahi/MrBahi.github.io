projects = [
    {
        ...
        "github":  "github.com/MrBahi/smp-tracker",
        "type":    "ML + API"
    },
    {
        ...
        "github":  "github.com/MrBahi/api-dashboard",
        "type":    "Data Pipeline"
    },
    {
        ...
        "github":  "github.com/MrBahi/browser-coach",
        "type":    "Web Tool"
    },
]
...
print(SEPARATOR)
sorted_projects = sorted(projects, key=lambda p: p["type"])
for i, project in enumerate(sorted_projects, start=1):
      print(f"{i}. Type: [{project['type']}] | Title: {project['title']}")
